...
$(document).ready(function () {
    ...
    function edit_data(id) {
        ...
        $.ajax({
            url: "../reviewlevel4/get_area_details/" + id,
            type: "GET",
            dataType: "json",
            success: function (data) {
                ...
                if (data.area_details) {
                    ...
                    areaDetails.forEach(function (item, index) {
                        ...
                        tableHtml += '<td><select name="status" style="height: 30px; border-radius: 5px; width: 100px"><option value="Level4 Approved">Approve</option><option value="Rejected">Reject</option></select></td>';
    ...
    function updateStatus(statusUpdates) {
        $.ajax({
            url: "../reviewlevel4/update_status",
            type: "POST",
            dataType: "json",
