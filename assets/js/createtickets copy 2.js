...
function validateForm() {
    ...
    $.post("../createtickets/add_area", 
    
    { type: type, activity: activity, details: details, impact_type: impact_type, before: before , after: after, target_date: target_date, level2_status: level2_status })
        .done(function (data) {
...
var formData = {
    ...
    attachment: $('#edit_attachment').val(),
