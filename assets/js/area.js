...
$(document).ready(function () {
    ...
    if (area === '') {
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: 'Department field cannot be empty'
        });
        ...
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: 'Division field cannot be empty'
        });
        return false; // prevent form submission
    ...
    Swal.fire({
        icon: 'error',
        title: 'Error',
        text: 'Section field cannot be empty'
    });
    return false; // prevent form submission
}
    ...
    //     method: 'POST'
    // },
    { divisionName: divisionName, areaName: areaName, locationName: locationName, userdata: userdata })
        .done(function (data) {
...
if (data.area_details) {
    ...
    var existingDivision = data.area_details.division;
    ...
    $('#edit_division').val(existingDivision);
...
Swal.fire({
    ...
    text: 'Combination of Division, Department and Section already exists.'
});
} else {
