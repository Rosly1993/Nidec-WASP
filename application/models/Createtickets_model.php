<?php
class Createtickets_model extends CI_Model {
	...
	public function get_areas() {
        ...
        $this->db->where_not_in('level2_status', array('Done','Accept','Reject'));
        // Execute the query
        $query = $this->db->get();
	...
	public function add_area($type, $activity, $details , $impact_type, $before, $after, $target_date, $level2_status, $attachment) {
