...
class Areas_model extends CI_Model {
	...
	public function add_area($areaName, $locationName, $userdata,$divisionName) {
	...
	public function get_area_by_name($area_name,$location,$division) {
		// $this->db->where('area', $area_name);
        $query = $this->db->get_where('set_areas', array('division' => $division, 'area' => $area_name, 'location' => $location));
		// $query = $this->db->get('set_areas');
