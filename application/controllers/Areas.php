...
class Areas extends CI_Controller {
    ...
    public function add_area() {
        ...
        if ($this->input->is_ajax_request()) {
            // Get form data
            $division = $this->input->post('divisionName');
            $area = $this->input->post('areaName');
            $location = $this->input->post('locationName');
            $created_by = $this->input->post('userdata');
    
            // Check if the area already exists
            $existing_area = $this->areas_model->get_area_by_name($area,$location,$division);
            if ($existing_area) {
                ...
                $this->areas_model->add_area($area, $location, $created_by,$division);
        ...
        public function update_area() {
            ...
            if ($existing_data['division'] === $division && $existing_data['area'] === $area && $existing_data['location'] == $location) {
            ...
            $existing_combination = $this->db->get_where('set_areas', array('division' => $division, 'area' => $area, 'location' => $location))->row_array();
