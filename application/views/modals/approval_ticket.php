    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="edit_modal_label">Ticket Approval</h5>
          ...
          <div  class="form-group col-4 col-md-4 col-sm-4">
            <label for="level2_status" class="control-label">Judgement</label><span style="color:red">*</span>
            <select type="text" class="form-control input-lg" style="height:63px" id="level2_status" name="level2_status" placeholder="Enter Location Here"   autocomplete="off">
          ...
          <div  class="form-group col-12 col-md-12 col-sm-12">
            ...
            <input type="text" class="form-control input-lg" style="height:63px" id="remarks" name="remarks" placeholder="Enter Remarks Here"   autocomplete="off">
          </div>
        </div>
                </form>
            </div>
