    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
          ...
          <div class="form-group col-4 col-md-4 col-sm-4">
            ...
            <select type="text" class="form-control input-lg" style="height:63px" id="edit_uom" name="uom" placeholder="Enter Location Here"  required autocomplete="off">
          ...
          <div  class="form-group col-4 col-md-4 col-sm-4">
            ...
            <select type="text" class="form-control input-lg" style="height:63px" id="level2_status" name="level2_status" placeholder="Enter Location Here"  required autocomplete="off">
