        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h3 text-white d-inline-block mb-0">Review Level2 Tables</h3>
    ...
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <?php $this->load->view("modals/level2") ?>
                <?php $this->load->view('components/footer.php'); ?>
                <script src='<?=base_url()?>assets/js/reviewlevel2.js'></script>
