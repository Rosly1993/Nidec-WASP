...
<div class="container-fluid mt--6">
    <div class="row">
        <div class="col">
            ...
            <div class="form-group col-md-4">
            <input type="month" class="form-control input-lg" id="date_ot" name="date_ot" placeholder="Enter Mold No Here" required autocomplete="off">  
            </div>
           <div class="form-group col-md-4" ><button  type="submit" style='height: 50px' class="btn btn-success" id="filterBtn">Filter Data</button></div>
            ...
            <center><div><b>Top(15) Operator's OT</b></div></center>
            <div><canvas id="fullnameBarChart" width="200" height="50"></canvas></div>
                <!-- Light table -->
