...
<div class="table-container" style="width: 100%; margin-left: 15px">
    <table style="width: 100%;">
        <tr>
            <td >
            <center>  <button class="btn btn-success"><a href="<?=site_url().'/excel/'?>" style="color:white;text-decoration: none; font-size: 20px"> <b>Excel </b>(<span id="accept_percentage1"></span>)</a></button></center>
