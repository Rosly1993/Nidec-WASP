...
<div class="table-container" style="width: 100%; margin-left: 15px">
    <table style="width: 100%;">
        <tr>
            <td >
            <center>  <button class="btn btn-success"><a href="<?=site_url().'/system/'?>" style="color:white;text-decoration: none; font-size: 20px"> <b>Digitization </b>(<span id="accept_percentage1"></span>)</a></button></center>
