        ...
        <div class="col">
            <div class="card">
                ...
                <div style="padding: 15px" class="table-responsive">
                    ...
                    <table id='items_table' class="table table-bordered table-striped tb" style="width: 100%" >
...
<?php $this->load->view("modals/add_user") ?>
<?php $this->load->view("modals/edit_user") ?>
<?php $this->load->view('components/footer.php'); ?>
<script src='<?=base_url()?>assets/js/userrole.js'></script>  
